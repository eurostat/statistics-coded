...
install.packages(c("tidyr", "repr", "dplyr"), dependencies=TRUE, repos="https://cloud.r-project.org")
...
install.packages("restatapi", dependencies=TRUE, repos="https://cloud.r-project.org")
